...
\begin{tabular}{@{}lp{10.5cm}@{}}
  ...
  Credits         & 3 \\[0.2cm]
  Member(s)       & Mr. Peeraphat Siripathanakun \\
                  & Mr. Phattaradon Thanaprasitpattana \\[0.3cm]
  Project Advisor & Assoc.\ Prof.\ Dr.\ Nontapon Leeraj \\[0.2cm]
  Co-advisor      & Assoc.\ Prof.\ Dr.\ Panit Ajchararit \\
                  & Dr.\ Kritsana Jaengsamsi \\[0.3cm]
  Program         & Bachelor of Engineering \\[0.1cm]
  Field of Study  & Computer Engineering \\[0.1cm]
...
and has been \textbf{successfully deployed for production use at the Chulabhorn Royal Academy (CRA)} hospital server.
...
\begin{tabular}{@{}lp{10cm}@{}}
  หัวข้อปริญญานิพนธ์  & การสำรวจปัญญาประดิษฐ์สำหรับการตรวจจับวงยับยั้ง \\
                      & ในการทดสอบความไวต่อยาปฏิชีวนะ \\[0.3cm]
  หน่วยกิต            & 3 \\[0.2cm]
  ผู้เขียน             & นายพีรพัฒน์ ศิริพัฒนคุณ \\
                      & นายภัทรดนย์ ธนาประสิทธิ์ปัญญา \\[0.3cm]
  อาจารย์ที่ปรึกษา     & รศ.\ ดร.\ นนทพร ลีราช \\[0.2cm]
  ที่ปรึกษาร่วม        & รศ.\ ดร.\ ปณิต อัจฉรารัตน์ \\
                      & ดร.\ กฤษณา แจงแสงสี \\[0.3cm]
  หลักสูตร             & วิศวกรรมศาสตรบัณฑิต \\[0.1cm]
  สาขาวิชา            & วิศวกรรมคอมพิวเตอร์ \\[0.1cm]
...
ไวต่อยา (Susceptible: S), ก้ำกึ่ง (Intermediate: I) หรือ ดื้อยา (Resistant: R) โดยอัตโนมัติ
...
บนเครื่องเซิร์ฟเวอร์ของ \textbf{วิทยาลัยวิทยาศาสตร์การแพทย์เจ้าฟ้าจุฬาภรณ์ (CRA)}
