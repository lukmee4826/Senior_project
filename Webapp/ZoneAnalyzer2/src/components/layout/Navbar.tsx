        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              ...
              className={`px-3 py-2 rounded-lg transition-colors ${currentPage === 'dashboard'
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg transition-colors ${currentPage === 'history'
                  ? isDark ? 'text-blue-400 bg-gray-800' : 'text-blue-600 bg-blue-50'
                  : isDark ? 'text-gray-300 hover:text-gray-100 hover:bg-gray-800' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-100'
                }`}
            >
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg transition-colors flex items-center gap-1 ${currentPage === 'admin'
                  ? isDark ? 'text-blue-400 bg-gray-800' : 'text-blue-600 bg-blue-50'
                  : isDark ? 'text-gray-300 hover:text-gray-100 hover:bg-gray-800' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-100'
                }`}
            >
